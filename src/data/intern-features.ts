...
export const mousBacklog: ProductBacklog = {
  ...
  features: [
    ...
    { id: "M-21", title: "More templates", detail: "Hotel, salon and pharmacy are done — add gym, school and car-rental templates with realistic sample data and opening hours.", category: "Business Setup", difficulty: "Beginner", skills: ["Content", "JavaScript"], startHere: "worker/src/app.html → TEMPLATES" },

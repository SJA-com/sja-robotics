...
import Fasha from "@/components/Fasha";
  ...
  return (
    <section id="sja-ai" className="py-24 relative bg-hextech overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-2xl bg-surface border border-border p-8 sm:p-10 mb-24">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              {
                name: "Moussa",
                tagline: "Multilingual Omnipresent Unified Speech Smart Agent",
                badge: "Coming Soon",
        ...
        <div className="mb-24">
          <div className="text-center mb-10">
            ...
            <h3 className="text-3xl sm:text-4xl font-bold mb-2">
              <span className="text-accent-2">Moussa</span>
            </h3>
            <p className="text-accent-2/60 text-sm font-mono mb-3">
              Multilingual Omnipresent Unified Speech Smart Agent
            </p>
        ...
        {/* ─── PRODUCT 2: SJA COMPANION — merged into Fasha (uncomment when needed) ─── */}
        {/* Full SJA Companion section preserved in git history */}

      </div>

      {/* ─── PRODUCT 2: FASHA — Full-width breakout section ─── */}
      <Fasha />

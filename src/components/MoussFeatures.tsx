...
const statusRows: { feature: string; today: string; status: Status }[] = [
  ...
  { feature: "Call analytics dashboard", today: "Owner login; bookings, satisfaction, busiest hours and CSV export", status: "Live in demo" },
  { feature: "Opening hours", today: "Per-day hours and time zone — MOUS knows if you're open right now", status: "Live in demo" },
  { feature: "Customer link & website widget", today: "Publish your agent, share a link or embed it on your site", status: "Live in demo" },
  { feature: "Menu & price-list import", today: "Upload a menu or price list and MOUS fills in your details", status: "Live in demo" },
  { feature: "Conversation summaries", today: "Summary, outcome and estimated satisfaction for every conversation", status: "Live in demo" },
